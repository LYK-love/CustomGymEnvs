...
env = gym.make('custom_envs/BouncingBall-v0', render_mode="human", size=2,  velocity_scale = 1.0, ball_radius_ratio = 0.1, wall_thickness_ratio = 0.01, apply_action=False, log=True)
