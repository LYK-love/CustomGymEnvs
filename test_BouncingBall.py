...
env = gym.make('custom_envs/BouncingBall-v0', render_mode="human", size=2, velocity_scale = 1.0, ball_radius_ratio = 0.05, wall_thickness_ratio = 0.01, energy_loss_factor=0.9, apply_action=False, log=True)
